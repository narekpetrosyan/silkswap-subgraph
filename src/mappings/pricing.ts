...
const USDC_WETH_PAIR = '0x9448cb1c997192Cb3969c306d3ea021E07AB1D43'
const USDT_WETH_PAIR = '0xa6546F0509c6D4A7B7E6388888A7141CA0Da2AbD'
...
export function findEthPerToken(token: Token): BigDecimal {
  ...
  for (let i = 0; i < WHITELIST.length; ++i) {
    ...
    if (pairAddress && pairAddress.toHexString() != ADDRESS_ZERO) {
